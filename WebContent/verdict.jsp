...
<body>
	...
	<center>
		<h1>Verdict List!</h1>
		<i>Wrong answer on test 97 --WrongAnswerOnTest97</i>
		<hr/>
		
		<h2>In queue</h2>
		<i>5 pages of in queue... --XGN</i> <br/>
		This verdict means your program will be judged soon and now it is waiting for other programs to judge.
		
		<h2>Compiling</h2>
		<i>En? CE!! --Zzzyt</i><br/>
		This verdict means your program is compiling.
		
		<h2>Compile Error</h2>
		<i>Ah!I forget to delete windows.h! --XGN</i> <br/>
		This verdict means your program cannot pass our compile system.
